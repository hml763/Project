...
def main():
    ...
    model = cv2.imread('C:/Users/hml76/PycharmProjects/Network_security/10.jpg')
    ...
    while True:
        ...
        kp_prev, des_prev = orb.detectAndCompute(model, None)
        ...
        frame_mod = cv2.drawMatches(model, kp_prev, frame, kp_curr, matches[:10], frame_mod, flags=2)
